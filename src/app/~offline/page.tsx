    ...
    <section className="container-x flex min-h-[70dvh] items-center justify-center py-12">
      <div className="card-clinical w-full max-w-2xl p-6 text-center sm:p-10">
        ...
        <p className="mx-auto mt-3 max-w-xl leading-7 text-navy-600">
          {t(
            "بعض صفحات مركز الكمالية تحتاج إلى اتصال. يمكنك العودة إلى صفحة محفوظة أو استخدام الأدوات المحلية المتاحة على جهازك.",
            "Some KAMALIA pages need a connection. You can return to a saved page or use tools already available on your device.",
          )}
        </p>
