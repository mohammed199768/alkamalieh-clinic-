...
export const PRODUCT = {
  ...
  label: {
    ar: "رحلتك الصحية مع مركز الكمالية",
    en: "Your Health Journey with KAMALIA",
  } as Bilingual,
  brandMessage: {
...
export const PRIVACY = {
  ...
  copy: {
    ar: "لا تحتاج إلى إنشاء حساب. القياسات والملاحظات التي تضيفها تُحفظ محليًا في هذا المتصفح، ولا تُرسل إلى مركز الكمالية أو أي خدمة خارجية.",
    en: "No account is required. Measurements and notes are stored locally in this browser and are not sent to KAMALIA Medical Center or any external service.",
  } as Bilingual,
  points: [
    {
      icon: "shield",
