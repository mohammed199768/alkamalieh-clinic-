 ...
 *
 * ⚠️ TEMPORARY PLACEHOLDERS — these are Unsplash photographs used only while the
 * real Al Kamalia Medical Center photography is being produced. Replace every URL
...
export const MEDIA = {
  ...
  heroAlt: {
    ar: "رعاية طبية هادئة واحترافية في مركز الكمالية الطبي",
    en: "Calm, professional medical care at Al Kamalia Medical Center",
  },
