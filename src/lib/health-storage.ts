/**
 * Centralized local-first storage adapter for the KAMALIA Health Companion.
 *
 * Design goals:
...
export const STORAGE_KEY = "kamalia.healthCompanion.v1";

const CHANGE_EVENT = "kamalia:health-store-change";
...
/** Cryptographically-random id where available, with a safe fallback. */
