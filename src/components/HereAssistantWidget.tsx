...
const SCENARIOS: Scenario[] = [
  ...
  { id: "emergency", q: { ar: "لدي حالة طارئة", en: "I have an emergency" },
    a: { ar: "إذا كانت الحالة خطيرة ومهددة للحياة، اتصل بخدمات الطوارئ المحلية فوراً. للحالات العاجلة لدينا يمكنك الاتصال بالمركز مباشرة على 0796119707.",
         en: "If it is severe or life-threatening, call local emergency services immediately. For urgent cases you can call the center directly at 0796119707." },
    wa: "مرحباً، لدي حالة عاجلة وأحتاج المساعدة." },
  ...
  { id: "insurance", q: { ar: "هل تقبلون التأمين؟", en: "Do you accept insurance?" },
    a: { ar: "المركز معتمد لدى عدد من شركات التأمين. أرسل لنا اسم شركتك عبر واتساب ونؤكد لك التغطية.",
         en: "The center is accepted by several insurance companies. Send us your company name on WhatsApp and we'll confirm coverage." },
