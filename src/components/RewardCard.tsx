...
export default function RewardCard({
  ...
  const msgAr =
    "حصل صغيرنا الذكي على بطاقة تشجيعية من مركز الكمالية الطبي — اسأل المركز عن الهدية المتاحة عند الزيارة.";
  const msgEn =
    "Your smart little one earned a special encouragement card from Al Kamalia Medical Center — ask the center about the available gift during your visit.";
  ...
  const qrValue = JSON.stringify({
    ...
    game: gameName.en,
    score: score ?? "",
    center: "Al Kamalia Medical Center",
  });
