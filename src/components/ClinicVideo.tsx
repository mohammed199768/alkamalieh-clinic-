  ...
  return (
    <figure className={`relative overflow-hidden bg-navy-950 ${className}`}>
      {showVideo ? (
        ...
        >
          {L({
            ar: "متصفحك لا يدعم تشغيل الفيديو. هذه جولة قصيرة داخل مركز الكمالية الطبي.",
            en: "Your browser does not support the video. This is a short tour inside KAMALIA Medical Center.",
          })}
        </video>
      ) : (
        <button
