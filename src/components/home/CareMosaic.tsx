...
const MOSAIC: MosaicItem[] = [
  { photo: "photo_01", ar: "طب عام", en: "General medicine", num: "01", feat: true },
  { photo: "photo_04", ar: "زيارة منزلية", en: "Home visit", num: "02" },
  { photo: "photo_05", ar: "رعاية الأطفال", en: "Children care", num: "03" },
  { photo: "photo_06", ar: "متابعة الأمراض المزمنة", en: "Chronic follow-up", num: "04" },
  { photo: "photo_07", ar: "فحوصات مخبرية", en: "Lab tests", num: "05" },
  { photo: "photo_04", ar: "جلسات الحديد بالوريد", en: "IV iron sessions", num: "06" },
];
