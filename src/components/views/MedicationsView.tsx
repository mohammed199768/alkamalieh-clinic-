...
export default function MedicationsView() {
  ...
  const exportCsv = () => downloadCsv(`kamalia-medications-${fileDateStamp()}.csv`, store.medications, [
      ...
      <div className="health-print">
        <div className="screen-only grid gap-8 lg:grid-cols-[minmax(0,1fr)_21rem]">
          <div className="space-y-8">
            ...
            <LocalDataControls sectionLabel={{ ar: "قائمة الأدوية", en: "medication list" }} onExportCsv={exportCsv} onExportJson={() => downloadJson(`kamalia-medications-${fileDateStamp()}.json`, JSON.stringify(store.medications, null, 2))} onClearSection={() => clearCollection("medications")} />
