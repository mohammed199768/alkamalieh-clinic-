...
export default function BloodPressureView() {
  ...
  const exportCsv = () => downloadCsv(`kamalia-blood-pressure-${fileDateStamp()}.csv`, rows, [
      ...
      <div className="health-print">
        <div className="screen-only grid gap-8 lg:grid-cols-[minmax(0,1fr)_21rem]">
          <div className="space-y-8">
            ...
            <LocalDataControls sectionLabel={{ ar: "قراءات ضغط الدم", en: "blood-pressure readings" }} onExportCsv={exportCsv} onExportJson={() => downloadJson(`kamalia-blood-pressure-${fileDateStamp()}.json`, JSON.stringify(rows, null, 2))} onClearSection={() => clearCollection("bloodPressure")} />
          </div>
