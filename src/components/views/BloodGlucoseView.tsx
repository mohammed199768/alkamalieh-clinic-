...
export default function BloodGlucoseView() {
  ...
  const exportCsv = () => downloadCsv(`kamalia-blood-glucose-${fileDateStamp()}.csv`, rows, [
      ...
      <div className="health-print">
        <div className="screen-only grid gap-8 lg:grid-cols-[minmax(0,1fr)_21rem]">
          <div className="space-y-8">
            ...
            <LocalDataControls sectionLabel={{ ar: "قراءات سكر الدم", en: "blood-glucose readings" }} onExportCsv={exportCsv} onExportJson={() => downloadJson(`kamalia-blood-glucose-${fileDateStamp()}.json`, JSON.stringify(rows, null, 2))} onClearSection={() => clearCollection("bloodGlucose")} />
